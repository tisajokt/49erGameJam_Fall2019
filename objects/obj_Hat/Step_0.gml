	...
	switch(hat_num){
		...
		case 2: //power hat
			if(move_state = move_state.idle){
				...
				sprite_index = spr_PowerHatRun;
			} else if (move_state = move_state.attack){
				switch(weapon){
					case 0: //pitchfork
						sprite_index = spr_PowerHatPicthforkAttack;
						break;
					case 1: //crossbow
						sprite_index = spr_PowerHatCrossbowAttack;
						break;
					case 2: //sword
						sprite_index = spr_PowerHatSwordAttack;
						break;
				}
			} else if(move_state = move_state.jump_falling){
				sprite_index = spr_PowerHatJumpFalling;
			} else if(move_state = move_state.jump_rising){
				sprite_index = spr_PowerHatJumpRising;
			}
			break;
			break;
	}
